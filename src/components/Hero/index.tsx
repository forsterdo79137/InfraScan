            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[1000px] text-center">
                <h1 className="mb-6 text-4xl font-bold leading-tight text-white sm:text-5xl sm:leading-tight md:text-6xl md:leading-tight lg:text-7xl lg:leading-tight">
                  Find Your Perfect
                  <span className="block text-primary">Infrastructure Solution</span>
                </h1>
                <p className="mb-12 text-lg leading-relaxed text-white/90 sm:text-xl md:text-2xl">
                  Whether inspecting bridges, analyzing structural integrity, or monitoring aging infrastructure, 
                  the right AI-powered solution can help you feel confident, efficient, and ready for any challenge.
                </p>
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-6 sm:space-y-0">
                  <Link
                    href="#contact"
                    className="group relative overflow-hidden rounded-lg bg-white px-8 py-4 text-lg font-semibold text-primary shadow-lg transition-all duration-300 hover:bg-accent-terracotta hover:text-white hover:shadow-xl"
                  >
                    <span className="relative z-10">Find Your Solution</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-accent-terracotta to-secondary opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                  </Link>
                  <Link
                    href="#features"
