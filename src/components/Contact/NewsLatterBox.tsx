    ...
    return (
      <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
        <h3 className="mb-4 text-2xl leading-tight font-bold text-black dark:text-white">
          Stay Updated on InfraScan Launch
        </h3>
        <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
          Be the first to know when InfraScan launches in Q2 2026. Get exclusive early access, product updates, and industry insights delivered to your inbox.
        </p>
        <div>
          <input
            type="text"
          ...
          <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
            We respect your privacy. No spam, just valuable updates about InfraScan.
          </p>
        </div>
      </div>
    );
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#1e3a8a" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
